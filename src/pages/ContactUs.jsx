    ...
    <>
      <section className="font-sans">
        ...
        <div className="container mx-auto">
          <div className="items-center grid-cols-1 xl:grid-cols-2 py-10 grid gap-8 z-10 -mt-44 absolute bg-[#F6F4F2] container mx-auto">
            <div className="px-10 ml-10  flex flex-col justify-center">
              <div className="pb-10">
                <h4 className="text-[50px] font-bold">Contact Us</h4>
                <p className="pb-6">
                  Suspendisse leo et cursus pharetra tellus tincidunt. Risus
                  nulla penatibus donec elementum nulla
                </p>
              </div>

              <div className="flex flex-col justify-center gap-5">
                <div>
                  <p className="flex gap-2 opacity-50 text-[16px]">
                    <img src={mapPin} alt="" />
                    Physical address
                  </p>
                  <p className="font-bold text-[24px] pl-8">
                    60 Fremont Ave. Hamden, <br />
                    CT 06514
                  </p>
                </div>
                <div>
                  <p className="flex gap-2 opacity-50 text-[16px]">
                    <img src={contPhone} alt="" />
                    Phone number
                  </p>
            ...
            <form action="" className="bg-white py-16 px-11 mx-14">
              ...
              <button className="bg-[#947458] px-10 py-3 text-[15px] rounded-sm text-white my-6">
                Send Message
              </button>
            </form>
          </div>
